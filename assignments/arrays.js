...
let carYears = inventory.map(function (element) {
...
let oldCars = inventory.filter(function (element) {
...
let BMWAndAudi = inventory.filter(function (element) {
    return element.car_make === "Audi" || element.car_make === "BMW";
});
